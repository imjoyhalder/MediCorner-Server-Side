...
var addMedicineWithInventory = async (sellerId, payload, file) => {
  try {
    const {
      name,
      brandName,
...
router.post("/", auth_default("SELLER" /* SELLER */), upload.single("thumbnail"), medicineController.createMedicine);
